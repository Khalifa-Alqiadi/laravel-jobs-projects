...
<h1 class="text-center">Manage User Skills</h1>
    <div class="container">
        <div class="table-responsive">
            <table class="main-table manage-members text-center table table-bordered">
                <tr>
                ...
                <tr>
                    ...
                    <td>{{$skill->skills->percent}}%</td>
                    <td>{{$skill->name}}</td>
                    <td>
                        @if($skill->skills->is_active == 1)
                            <a href="" class='btn btn-info activate' data-bs-toggle="modal" data-bs-target="#activeSkill">
                                <i class='fa fa-check'></i> Active
                            </a>
                        @else
                            <a href="" class='btn btn-danger activate' data-bs-toggle="modal" data-bs-target="#activeSkill">
                                <i class='fa fa-close'></i> noActive
                            </a>
                        @endif
                ...
                <div class="modal fade user" id="activeSkill" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form action="active_admin_user" method="post">
                                @csrf
                                ...
                                <div class="modal-body">
                                    <input type="hidden" name="userid" value="{{$skill->skills->id}}">
                                    <h2>Are You Sure!</h2>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
    ...
    <div class="container">
        <div class="table-responsive">
            <table class="main-table manage-members text-center table table-bordered">
                ...
                <tr>
                    <td>1</td>
                    <td>{{$experience->userExperience->name}}</td>
                    <td>{{$experience->userExperience->years}}</td>
                    <td>{{$experience->name}}</td>
                    <td>
                        @if($experience->userExperience->is_active == 1)
                            <a href="" class='btn btn-info activate' data-bs-toggle="modal" data-bs-target="#activeExperience">
                                <i class='fa fa-check'></i> Active
                            </a>
                        @else
                            <a href="" class='btn btn-danger activate' data-bs-toggle="modal" data-bs-target="#activeExperience">
                                <i class='fa fa-close'></i> noActive
                            </a>
                        @endif
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form action="active_admin_user" method="post">
                                ...
                                <div class="modal-body">
                                    <input type="hidden" name="userid" value="{{$experience->userExperience->id}}">
                                    <h2>Are You Sure!</h2>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
